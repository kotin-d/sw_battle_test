...
namespace sw::logic
{
	...
	public:
		...
		public:
			...
			virtual void onUnitSpawned([[maybe_unused]] Unit* unit, [[maybe_unused]] const Position& position) {};
			virtual void onUnitMoved([[maybe_unused]] Unit* unit, [[maybe_unused]] const Position& old, [[maybe_unused]] const Position& now) {};
			virtual void onUnitDied([[maybe_unused]] Unit* unit) {};
		};
	...
	public:
		...
		void spawn(Unit::Ptr unit, const Position& position);
		void kill(Unit* unit);
